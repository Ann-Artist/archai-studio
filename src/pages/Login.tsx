  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md space-y-8 animate-slide-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-sm text-blueprint hover:underline">
                  Forgot password?
                </a>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-muted-foreground">
            ...
            <Link to="/signup" className="text-blueprint font-medium hover:underline">
              Sign up for free
            </Link>
          </p>
        </div>
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-hero-gradient relative overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-blueprint/20 rounded-full blur-3xl animate-float" />
        ...
        <div className="relative z-10 text-center p-12 max-w-lg">
          ...
          <p className="text-white/70 text-lg">
            Access your AI-powered architecture toolkit and bring your visions to life.
          </p>
        </div>
      </div>
    </div>
